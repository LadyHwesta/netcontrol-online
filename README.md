...
- **Traffic management** — flag stations with traffic, interactive "called" tracking (persists across a session close/reopen), formal traffic message log with per-message **ICS-213 export** ready to paste into a Winlink message or attach as a .txt file for relay over radio
