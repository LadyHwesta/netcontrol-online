// Vendored copy of the ALTCHA widget (https://altcha.org), v2.3.0, MIT license.
// Source: https://github.com/altcha-org/altcha -- self-hosted here so bot protection
// works with zero third-party network calls (no CDN, no external verification service).
// Registers the <altcha-widget> custom element; load with type="module".
